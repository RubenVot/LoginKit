...
//		keyboardShowObserver = notificationCenter.addObserver(forName: NSNotification.Name.UIResponder.keyboardWillShowNotification, object: nil, queue: nil) { notification in
//            self.keyboardWillShow(notification)
//        }
//		keyboardHideObserver =  notificationCenter.addObserver(forName: NSNotification.Name.UIResponder.keyboardWillHideNotification, object: nil, queue: nil) { notification in
